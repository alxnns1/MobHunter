...
object MHBlocks {
	...
	fun register(event: RegistryEvent.Register<Block>) {
		event.registry.registerAll(
			...
			plant("sleep_herb", MHColours.CYAN),
			...
			plant("latchberry", MHColours.CYAN),
