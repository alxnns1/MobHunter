...
object MHBlocks {
	...
	fun register(event: RegistryEvent.Register<Block>) {
		event.registry.registerAll(
			// Herbs
			plant("herb", MHColours.GREEN),
			plant("antidote_herb", MHColours.BLUE),
			plant("fire_herb", MHColours.RED),
			plant("ivy", MHColours.GREEN),
			plant("sleep_herb", MHColours.LIGHT_BLUE),
			plant("sap_plant", MHColours.WHITE),
			plant("felvine", MHColours.YELLOW),
			plant("gloamgrass_root", MHColours.PINK),
			plant("hot_pepper", MHColours.RED),
			plant("snow_herb", MHColours.LIGHT_BLUE),
			plant("dragonvine", MHColours.PURPLE),
			plant("tough_dragonvine", MHColours.PURPLE),
			// Mushrooms
			plant("blue_mushroom", MHColours.BLUE),
			plant("nitroshroom", MHColours.ORANGE),
			plant("parashroom", MHColours.YELLOW),
			plant("toadstool", MHColours.PURPLE),
			plant("mopeshroom", MHColours.LIGHT_BLUE),
			plant("exciteshroom", MHColours.GREEN),
			plant("dragon_toadstool", MHColours.RED),
			// Berries
			plant("paintberry", MHColours.PINK),
			plant("might_seed", MHColours.RED),
			plant("adamant_seed", MHColours.ORANGE),
			plant("nulberry", MHColours.BLUE),
			plant("dragonfell_berry", MHColours.RED),
			plant("scatternut", MHColours.GREY),
			plant("needleberry", MHColours.GREY),
			plant("latchberry", MHColours.WHITE),
			plant("bomberry", MHColours.GREY),
			// Ores
