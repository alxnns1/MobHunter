...
class GoldenfishModel : EntityModel<GoldenfishEntity>() {
	...
	private val bodyFront = ModelRenderer(this, 0, 0).apply {
		...
		addChild(
			// Dorsal fin front
			ModelRenderer(this@GoldenfishModel, 2, 1).apply {
	...
	private val bodyRear = ModelRenderer(this, 0, 13).apply {
		...
		addChild(
			// Dorsal fin rear
			ModelRenderer(this@GoldenfishModel, 0, 2).apply {
		...
		addChild(
			// Tail
			ModelRenderer(this@GoldenfishModel, 20, 10).apply {
